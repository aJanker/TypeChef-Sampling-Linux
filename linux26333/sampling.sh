...
# single conf
    extraFlagsSC="--singleconf --rootfolder /scratch/janker/linuxMax"
 ...
 # pairwise
    extraFlagsPW="--pairwise --rootfolder /scratch/janker/linuxMax"
...
#    mv ${outBase}.errreport ${outBase}_pairwise.errreport 
 ...
 # code coverage nh
    extraFlagsCC="--rootfolder /scratch/janker/linuxMax --codecoveragenh"
